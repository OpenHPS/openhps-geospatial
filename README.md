...
object.setPosition(new Absolute2DPosition(6.55, 34.135, LengthUnit.METER), office);
...
@openhps/spaces does not provide an additional _SymbolicLocation_ for this trivial indicator. Instead, we utilise the `referenceObjectUID`
